# edited version so i can use it. if you stumble upon this, feel free to use it idk
echo "";
echo "                              _       _        ";
...
pulseaudio pasystray pamixer telegram-desktop go python python-pip wget mariadb \
...
xf86-video-nouveau xf86-video-vmware python-dbus httpie bind-tools \ 
...
# making user mrcz
arch-chroot /mnt useradd -m -G wheel -s /bin/zsh sam
